...
class TestTaskStatusManagement:
    ...
    def test_update_task_status(self, client: TestClient, db: Session):
    ...
    def test_complete_nonexistent_task_returns_404(self, client: TestClient):
    ...
    def test_bulk_status_update(self, client: TestClient, db: Session):
    ...
    def test_bulk_status_update_with_invalid_status_returns_422(self, client: TestClient):
    ...
    def test_bulk_status_update_ignores_nonexistent_tasks(self, client: TestClient, db: Session):
...
class TestBlockedTaskStatusRules:
    ...
    def test_update_task_with_blocker_sets_waiting_status(self, client: TestClient, db: Session):
